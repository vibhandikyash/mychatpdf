  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="scrollbar-soft flex-1 overflow-auto p-5">
        <div
          className="mx-auto min-h-[640px] max-w-3xl rounded-md border border-slate-300 bg-white p-8 shadow-panel"
          style={{ width: `${Math.min(100, zoom)}%`, transform: `scale(${zoom / 100})`, transformOrigin: "top center" }}
        >
          ...
          <div className="space-y-4 text-slate-700">
            ...
            <div className="mt-8 rounded-md border border-dashed border-slate-300 p-4 text-sm leading-6 text-slate-500">
              PDF rendering will use the backend signed URL when available. Citations and page controls already update
              this active page for source verification.
            </div>
          </div>
        </div>
      </div>
